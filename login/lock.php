...
$id = $_SESSION['userID'];
$queryLock = "SELECT * FROM users WHERE id = '$id'";
$resultLock = mysqli_query($conn, $queryLock);
$dataLock = mysqli_fetch_assoc($resultLock);
?>
<!DOCTYPE html>
<html lang="pt-br">
              ...
              <div class="card card-profile text-center card-hidden">
                <div class="card-header ">
                  <div class="card-avatar">
                    <a href="#">
                      <img class="img" src="../assets/img/users/<?php echo $dataLock['foto']; ?>">
                    </a>
                  </div>
                </div>
                <div class="card-body ">
